...
#include <iostream>
#include "UnsortedListPriorityQueue_midterm2.h"
...
int testUnsortedPriorityQueue()
{
	...
	q.enqueue(PriorityElement1<int>(5, 7));
	q.enqueue(PriorityElement1<int>(4, 2));
	q.enqueue(PriorityElement1<int>(3, 8));
	q.enqueue(PriorityElement1<int>(2, 0));
	q.enqueue(PriorityElement1<int>(1, 9));
